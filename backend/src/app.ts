...
import gpsPaymentRouter from './modules/gps-payments/gps-payment.router.js';
  ...
  cors({
    origin: (origin, callback) => {
      ...
      if (
        ...
        origin.includes('kidway.co') ||
        origin.includes('38.191.208.30') ||
...
app.use('/api/gps-payments', gpsPaymentRouter);
