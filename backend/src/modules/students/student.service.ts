...
const studentSelect = {
  ...
  home_latitude: true, home_longitude: true,
...
export async function updateStudent(id: string, input: UpdateStudentInput, actor: JwtPayload) {
  ...
  const updated = await prisma.student.update({
    ...
    data: {
      ...
      ...(input.route_morning_pickup !== undefined && { route_morning_pickup: input.route_morning_pickup }),
      ...(input.route_morning_arrival !== undefined && { route_morning_arrival: input.route_morning_arrival }),
      ...(input.route_afternoon_pickup !== undefined && { route_afternoon_pickup: input.route_afternoon_pickup }),
      ...(input.route_afternoon_arrival !== undefined && { route_afternoon_arrival: input.route_afternoon_arrival }),
