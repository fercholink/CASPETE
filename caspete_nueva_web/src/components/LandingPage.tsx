...
interface LandingPageProps {
  onStartDemo: (initialView?: 'parent' | 'canteen') => void;
}

export default function LandingPage({ onStartDemo }: LandingPageProps) {
  // Real-time warning seal test widget
  ...
  return (
    <div className="w-full bg-[#050505]">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-26 lg:pt-24">
          ...
          <div className="grid grid-cols-1 gap-y-16 gap-x-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <button
                  id="btn-parent-demo"
                  onClick={() => onStartDemo('parent')}
                  className="px-8 py-4 rounded-2xl text-black font-display font-black text-xs uppercase tracking-widest bg-[#98FF00] hover:bg-white hover:shadow-[#98FF00]/20 transition-all flex items-center justify-center gap-2 group cursor-pointer shadow-lg shadow-[#98FF00]/10 border-2 border-[#98FF00]"
                >
                  <span>Probar como Padre</span>
                  <ArrowRight className="h-4 w-4 stroke-[3px] group-hover:translate-x-1 transition-transform" />
                </button>
                <button
                  id="btn-canteen-demo"
                  onClick={() => onStartDemo('canteen')}
                ...
                >
                  <span>Probar como Colegio (Cajero)</span>
                  ...
                  {COLOMBIAN_FOOD_ITEMS.map((food) => (
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-3.5 rounded-xl border transition-all text-left group cursor-pointer ${
                        testFood.id === food.id
                          ? 'border-[#98FF00]/40 bg-[#121c14] ring-1 ring-[#98FF00]/20'
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs font-normal mt-1 text-zinc-400 leading-relaxed">
                      {testFood.isHealthy 
                        ...
                        : 'Si el padre bloquea este producto en el de configuración, Caspete bloqueará automáticamente la venta en el colegio, sugiriendo un reemplazo como "Porción de Fruta Picada" para cumplir la directriz de entornos escolares.'}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="bg-[#111111] p-8 rounded-[2rem] border border-white/5 flex flex-col justify-between space-y-8 relative overflow-hidden group hover:border-[#98FF00]/25 transition-all">
              ...
              <div className="space-y-4 text-left">
                ...
                <ul className="space-y-2.5 text-sm text-zinc-400">
                  <li className="flex items-center gap-x-2">
                    <Check className="h-4 w-4 text-[#98FF00] flex-shrink-0" />                  <Check className="h-4 w-4 text-brand-green-600 flex-shrink-0" />
                    <span>Programa loncheras saludables semanales</span>
                  </li>
                  <li className="flex items-center gap-x-2">
                    <Check className="h-4 w-4 text-brand-green-600 flex-shrink-0" />
              ...
              <button 
                onClick={() => onStartDemo('parent')}
                className="w-full py-3 rounded-xl border border-white/5 bg-[#1a1a1e] hover:bg-[#222226] text-zinc-100 font-bold transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
                <span>Saber más (Ver Demo Padre)</span>
            ...
            <div className="bg-[#111111] p-8 rounded-[2rem] border border-white/5 flex flex-col justify-between space-y-8 relative overflow-hidden group hover:border-[#98FF00]/25 transition-all">
              ...
              <button 
                ...
                className="w-full py-3 rounded-xl border border-white/5 bg-[#1a1a1e] hover:bg-[#222226] text-zinc-100 font-bold transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
                <span>Ver Punto de Venta (POS)</span>
                <ChevronRight className="h-4 w-4 text-[#98FF00]" />
              </button>
            </div>
            ...
            <div className="bg-[#160a22] text-white p-8 rounded-[2rem] border border-purple-950/40 flex flex-col justify-between space-y-8 relative overflow-hidden group hover:border-purple-500/30 transition-all">
              ...
              >
                <span>Iniciar Demo Integral</span>
      ...
      {/* General FAQ Section */}
      <section className="py-24 bg-[#050505] border-t border-white/5 pb-20">
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-white/5 pb-4">
                <button
                  ...
                  className="w-full flex justify-between items-center py-4 text-left font-display font-bold text-zinc-200 hover:text-[#98FF00] transition-colors text-base sm:text-lg focus:outline-hidden cursor-pointer"
                >
                  <span>{faq.q}</span>
      ...
      <section className="py-24 bg-gradient-to-b from-[#0e0e11] to-[#070709] border-t border-white/5 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 text-center space-y-8 relative z-10">
          <h2 className="font-display text-4xl font-black text-white max-w-2xl mx-auto tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center gap-4 max-w-md mx-auto">
            <button
              onClick={() => onStartDemo('parent')}
              className="px-8 py-4 rounded-xl text-black font-display font-bold bg-[#98FF00] hover:bg-[#a9ff2e] transition-all flex items-center justify-center gap-2 shadow-xl shadow-[#98FF00]/10 hover:shadow-[#98FF00]/20 cursor-pointer"
            >
              <span>Ingresar al Simulador App</span>
