...
export default function StudentsPage() {
  ...
  // Localizador GPS — el panel completo (info, acciones, SOS, alarma, config
  // avanzada) vive en el componente compartido GpsTrackerPanel; aquí solo se
  // guarda qué estudiante tiene el modal abierto.
                  ...
                  <div style={{ display: 'flex', gap: 8, flexShrink: 0, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                    ...
                    {isParent && student.active && (
                      <button
                        ...
                        onClick={() => setGpsStudentId(student.id)}
                      >
                        📍 GPS
                      </button>
                    )}
